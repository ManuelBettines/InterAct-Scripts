...
# GEOG file
geog = xr.open_dataset('geog_NEPALR1.nc')
...
from shapely.geometry.polygon import LinearRing
lons = [79.82556, 93.734436, 93.734436, 79.82556]
lats = [22.237251,22.237251,33.073074,33.073074]
ring = LinearRing(list(zip(lons, lats)))
ax.add_geometries([ring], ccrs.PlateCarree(), facecolor='none', edgecolor='k',linewidth=2.5,linestyle='-')


plt.annotate('d1',(106,41),fontsize=42,color='k')
