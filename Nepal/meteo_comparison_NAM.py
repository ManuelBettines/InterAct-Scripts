...
OBS_tem2 = pd.Series(df_obs['AT'],index=df_obs.index)
MOD_tem2 = extract_var(ds,'tem2',NAM_loc)

OBS_ws10 = pd.Series(df_obs['WS'],index=df_obs.index)
MOD_ws10 = extract_var(ds,'ws10m',NAM_loc)

OBS_wd = pd.Series(df_obs['WD'],index=df_obs.index)
MOD_u10 = units.Quantity(extract_var(ds,'u10m',NAM_loc).values,'m/s')
MOD_v10 = units.Quantity(extract_var(ds,'v10m',NAM_loc).values,'m/s')
...
plt.title('Namche - 2 meters temperature', fontsize=25)
...
#plt.savefig('output_figures/tem2_timeseries_NAM.png',dpi=500)
# plt.show()
...
#plt.savefig('output_figures/tem2_diurnal_NAM.png', dpi=500)
# plt.show()
...
ax1.xaxis.set_major_formatter(fmt)
ax1.grid(b = True, which = 'major', axis='x', color = '#666666', linestyle = '-', alpha = 0.2)
#plt.savefig('output_figures/ws_timeseries_NAM.png', dpi=500)
# plt.show()
...
ax1.tick_params(axis='both', which='major', labelsize=14)
# ax1.legend(loc='upper left',fontsize=16,ncol=2)
#plt.savefig('output_figures/ws_diurnal_NAM.png', dpi=500)
# plt.show()
#%% Wind direction 
...
ax1.xaxis.set_major_formatter(fmt)
ax1.grid(b = True, which = 'major', axis='x', color = '#666666', linestyle = '-', alpha = 0.2)
#plt.savefig('output_figures/wd_timeseries_NAM.png')
# plt.show()
...
ax1.tick_params(axis='both', which='major', labelsize=18)
#ax1.set(ylim=(0,360))
plt.title("Diurnal wind direction - Namche", fontsize=25)
plt.savefig('output_figures/wd_diurnal__NAM.png')
...
ax1.set_title('Namche - WRF-CHIMERE [9-15 Local Time]', fontsize=24)
ax1.set_yticks(np.arange(10, 40, step=10))
ax1.set_yticklabels(np.arange(10, 40, step=10))
ax1.tick_params(axis='both', which='major', labelsize=18)
ax1.set_legend()
ax1.set_ylim(0,40)
plt.savefig('output_figures/wr_model_day_NAM.png', dpi=500)
# plt.show()
...
ax1.tick_params(axis='both', which='major', labelsize=18)
ax1.set_legend()
#plt.savefig('output_figures/wr_model_night_NAM.png', dpi=500)
# # plt.show()
# #%% windrose obs
...
# # ax1.set_legend()
ax1.set_title('Namche - Observations [9-15 Local Time]', fontsize=24)
ax1.set_yticks(np.arange(10, 40, step=10))
ax1.set_yticklabels(np.arange(10, 40, step=10))
ax1.tick_params(axis='both', which='major', labelsize=18)
ax1.set_legend()
ax1.set_ylim(0,40)
plt.savefig('output_figures/wr_obs_day_NAM.png', dpi=500)
# # plt.show()
...
ax1.tick_params(axis='both', which='major', labelsize=18)
ax1.set_legend()
#plt.savefig('output_figures/wr_obs_night_NAM.png')
# # plt.show()
