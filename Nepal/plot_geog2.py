...
# GEOG file
geog = xr.open_dataset('geog_NEPALR2.nc')
...
geogr = plt.pcolormesh(geog.XLONG_M[0,:,:], geog.XLAT_M[0,:,:], ds_mask[:,:],transform=ccrs.PlateCarree(), cmap='terrain',vmin=-2300,vmax=6500)
...
from shapely.geometry.polygon import LinearRing
lons = [84.64487, 88.91513, 88.91513, 84.64487]
lats = [26.131668,26.131668,29.423378,29.423378]
ring = LinearRing(list(zip(lons, lats)))
ax.add_geometries([ring], ccrs.PlateCarree(), facecolor='none', edgecolor='k',linewidth=2.5,linestyle='-')


plt.annotate('d2',(92.7,32.2),fontsize=42,color='k')
